...
COLUMNS = [
    ...
    ("Website", "website", 40),
    ("Nomor Kontak", "contact_number", 22),
]
...
def _add_summary_sheet(wb: Workbook, filters: dict, total: int):
    ...
    rows = [
        ...
        ("Source", "Kemendikdasmen (data.belajar.id)"),
        ...
        ("WhatsApp", "School WhatsApp number (from Google/DeepSeek)"),
        ("Website", "School official website (from Google/DeepSeek)"),
        ("Nomor Kontak", "School contact number (from Google/DeepSeek)"),
    ]
